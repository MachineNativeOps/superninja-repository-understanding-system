...
class A2AClient:
    ...
    def __init__(
        self, agent_id: str, agent_info: AgentInfo, tracer: Optional[Tracer] = None
    ):
    ...
    async def _query_discovery_service(self, discovery_url: str) -> List[AgentInfo]:
    ...
    async def delegate_task(
        self, target_agent_id: str, request: DelegationRequest
    ) -> DelegationResponse:
        """
    ...
    async def send_message(self, target_agent_id: str, message: A2AMessage) -> bool:
        """
    ...
    async def _send_message(
        self, target_agent: AgentInfo, message: A2AMessage
    ) -> Optional[A2AMessage]:
    ...
    async def _handle_discovery(self, message: A2AMessage) -> A2AMessage:
        ...
        return A2AMessage(
            ...
            payload={"agent_info": self.agent_info.to_dict()},
        )
