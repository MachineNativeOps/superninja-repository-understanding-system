...
class MCPSecurity:
    ...
    async def authenticate(
        self, credentials: Dict[str, Any], method: AuthMethod = AuthMethod.JWT
    ...
    async def filter_pii(
        self, data: Dict[str, Any], context: Optional[SecurityContext] = None
    ) -> Dict[str, Any]:
        """
    ...
    def generate_token(self, user_id: str, expiry: Optional[timedelta] = None) -> str:
        """
