...
class GitHubOAuthVerifier:
    ...
    def verify_github_organization(self, org_name: str, oauth_token: str) -> Tuple[bool, Dict]:
        ...
        try:
            ...
            if user_response.status_code != 200:
                return False, {"error": f"GitHub API error: {user_response.status_code}"}
            ...
            org_info_response = requests.get(
                f"{self.github_api_base}/orgs/{org_name}",
                headers=headers,
                timeout=30
            )
