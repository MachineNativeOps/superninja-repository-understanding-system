...
class TestMCPVerificationSystem:
    ...
    def test_determine_verification_method(self):
        ...
        assert self.verifier.determine_verification_method("io.github.username") == VerificationMethod.GITHUB_OAUTH
        assert self.verifier.determine_verification_method("io.github.organization") == VerificationMethod.GITHUB_OAUTH
        
        # Test DNS/HTTP namespaces
        assert self.verifier.determine_verification_method("com.company") == VerificationMethod.DNS_TXT
        assert self.verifier.determine_verification_method("org.organization") == VerificationMethod.DNS_TXT
        assert self.verifier.determine_verification_method("net.domain") == VerificationMethod.DNS_TXT
    ...
    def test_verify_github_oauth_success(self):
        ...
        with patch.object(self.verifier.github_verifier, 'verify_namespace') as mock_verify:
            mock_result = Mock()
            ...
            result = self.verifier.verify_namespace("io.github.testuser", oauth_token="test-token")
...
class TestGitHubOAuthVerifier:
    ...
    def test_verify_user_invalid_token(self):
        ...
        with patch('requests.get') as mock_get:
            ...
            success, data = self.verifier.verify_github_user("testuser", "invalid-token")
...
class TestDnsTxtVerifier:
    ...
    def test_extract_domain_from_namespace(self):
        ...
        assert self.verifier.extract_domain_from_namespace("org.organization") == "organization"
...
class TestIntegration:
    ...
    def test_batch_verification(self):
        ...
        with patch.object(self.verifier, 'verify_namespace') as mock_verify:
            ...
            mock_verify.side_effect = [
                ...
                Mock(success=False, namespace="com.company", error_message="DNS verification failed")
            ]
    ...
    @pytest.mark.parametrize("namespace,expected_method", [
