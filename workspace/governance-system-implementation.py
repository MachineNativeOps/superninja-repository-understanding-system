...
class GovernanceClosedLoopSystem:
    ...
    def __init__(self, config_path: str = None):
        ...
        # Gate 分級配置
        self.gate_thresholds = self.config.get(
            "gate_thresholds",
            {
    ...
    def _load_config(self, config_path: str) -> Dict[str, Any]:
        ...
        default_config = {
            ...
            "storage": {"immutable": True, "retention_years": 7, "encryption": True},
        }
    ...
    # ===== 1. Gate 機制設計 =====
    def evaluate_gates(
        self, artifact_info: Dict[str, Any], verification_results: Dict[str, Any]
    ) -> Dict[str, Any]:
        """評估 Gate 決策"""
    ...
    def create_rollback_point(
        self, trace_id: str, version: str, components: List[Dict[str, Any]]
    ) -> RollbackPoint:
        """創建回滾點"""
...
def main():
    ...
    try:
        ...
        verification_results_file = (
            "outputs/supply-chain-evidence/supply-chain-verification-final-report.json"
        )
        ...
        evidence_bundle = governance.create_evidence_bundle(
            gate_results["trace_id"], verification_results, gate_results
        )

        # 4. 創建回滾點
        rollback_point = governance.create_rollback_point(
            gate_results["trace_id"], "v1.0.0", [artifact_info]
        )
