...
class EmergencyRecovery:
    ...
    def __init__(self):
        ...
        self.core_config = {
            ...
            "auto_start": True,
            "auto_recover": True,
            "engine_paths": ["./tools/automation/engines", "./engines"],
    ...
    async def check_dependencies(self) -> bool:
        ...
        required_modules = ["master_orchestrator", "asyncio", "pathlib", "datetime"]
        ...
        try:
            ...
            if success:
                ...
                for engine in engines:
                    self.log(
                        f"  • {engine.name} [{engine.engine_type.value}] - {'健康' if engine.healthy else '异常'}"
                    )
    ...
    async def health_check(self) -> dict:
        ...
        try:
            result = subprocess.run(
                ["pgrep", "-f", "master_orchestrator"], capture_output=True, text=True
            )
            ...
            health_status["checks"]["process"] = {"status": "error", "message": str(e)}
