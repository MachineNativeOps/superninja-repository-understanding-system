...
class ConfigurationManager:
    ...
    def update_configuration(
        self, config_name: str, updates: Dict[str, Any], persist: bool = False
    ) -> Dict[str, Any]:
        """
    ...
    def register_callback(
        self, config_name: str, callback: Callable[[Dict[str, Any]], None]
    ) -> None:
        """
    ...
    def export_configuration(
        self, config_name: str, output_file: str, include_overrides: bool = False
    ) -> None:
