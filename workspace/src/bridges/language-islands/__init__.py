    ...
    * ``legacy_alias`` – an optional fully qualified import path used for
    ...
    if spec and spec.loader:
        ...
        try:
            ...
            # Clean up partially-initialized modules from sys.modules on
            # failure
...
# Import base classes
_base_island = _import_kebab_module(
    "base_island", "base-island.py", legacy_alias="islands.base_island"
)
...
_python_island = _import_kebab_module(
    "python_island", "python-island.py", legacy_alias="islands.python_island"
)
PythonIsland = _python_island.PythonIsland

_rust_island = _import_kebab_module(
    "rust_island", "rust-island.py", legacy_alias="islands.rust_island"
)
...
_java_island = _import_kebab_module(
    "java_island", "java-island.py", legacy_alias="islands.java_island"
)
JavaIsland = _java_island.JavaIsland

# Import utilities
_island_utils = _import_kebab_module(
    "island_utils", "island-utils.py", legacy_alias="islands.island_utils"
)
