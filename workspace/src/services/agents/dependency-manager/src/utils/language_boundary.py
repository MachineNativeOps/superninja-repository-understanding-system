...
class LanguageRegistry:
    ...
    TERMS = {
        ...
        "transitive_dependency": TranslationEntry(
            "transitive_dependency", "傳遞依賴", "Transitive Dependency", "传递依赖"
        ),
        "dev_dependency": TranslationEntry(
            "dev_dependency", "開發依賴", "Dev Dependency", "开发依赖"
        ),
        ...
        "current_version": TranslationEntry(
            "current_version", "當前版本", "Current Version", "当前版本"
        ),
        "latest_version": TranslationEntry(
            "latest_version", "最新版本", "Latest Version", "最新版本"
        ),
        ...
        "estimated_time": TranslationEntry(
            "estimated_time", "預估時間", "Estimated Time", "预估时间"
        ),
        ...
        "security_first": TranslationEntry(
            "security_first", "安全優先", "Security First", "安全优先"
        ),
        # 生態系統
...
class LanguageBoundary:
    ...
    def t(self, key: str, lang: OutputLanguage | None = None) -> str:
        """
        翻譯術語
    ...
    def msg(self, key: str, lang: OutputLanguage | None = None, **kwargs) -> str:
        """
        獲取格式化消息
...
# 全域語言邊界實例
_language_boundary: LanguageBoundary | None = None
