...
class LatencyMonitor:
    ...
    def check_all_stages_within_threshold(self) -> Dict[str, Any]:
        ...
        check = {"name": "all_stages_within_threshold", "passed": True, "details": []}
    ...
    def check_total_latency_compliant(self) -> Dict[str, Any]:
        ...
        check = {"name": "total_latency_compliant", "passed": True, "details": []}
    ...
    def check_no_bottlenecks(self) -> Dict[str, Any]:
        ...
        check = {"name": "no_bottlenecks", "passed": True, "details": []}
