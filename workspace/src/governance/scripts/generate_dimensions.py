...
DIMENSIONS = [
    ...
    (
        ...
        "組織願景、策略目標與長期規劃治理",
        ["vision", "strategy", "planning", "objectives"],
        "strategic",
        [],
    ),
    (
        ...
        "企業架構、技術架構與治理框架設計",
        ["architecture", "design", "framework", "patterns"],
        "strategic",
        ["00-vision-strategy"],
    ),
    (
        ...
        "Decision Governance",
        "決策流程、審批機制與決策追蹤",
        ["decision", "approval", "workflow", "tracking"],
        "strategic",
    ...
    (
        ...
        "Change Governance",
        "變更管理、版本控制與影響評估",
        ["change", "version", "impact", "management"],
        "strategic",
        ["02-decision"],
    ),
    (
    ...
    (
        ...
        "法規遵循、標準符合與合規驗證",
        ["compliance", "regulation", "standard", "verification"],
        "strategic",
        ["04-risk"],
    ),
    (
        ...
        "Security Governance",
        "資訊安全、存取控制與威脅管理",
        ["security", "access", "threat", "protection"],
        "strategic",
        ["04-risk", "05-compliance"],
    ),
    (
        "07",
        "audit",
        ...
        "Audit Governance",
        "稽核流程、證據收集與報告生成",
        ["audit", "evidence", "report", "trail"],
        "strategic",
        ["05-compliance", "06-security"],
    ),
    (
        "08",
        "process",
        ...
        "Process Governance",
        "流程定義、優化與自動化",
        ["process", "workflow", "optimization", "automation"],
        "strategic",
        ["01-architecture"],
    ),
    (
        ...
        "績效指標、KPI定義與目標追蹤",
        ["performance", "kpi", "metrics", "goals"],
        "strategic",
        ["00-vision-strategy", "08-process"],
    ),
    ...
    (
        ...
        "政策治理",
        "Policy Governance",
        "Policy-as-Code框架、政策定義與執行",
        ["policy", "rules", "enforcement", "pac"],
        "operational",
        ["00-vision-strategy", "05-compliance"],
    ),
    (
        "11",
        "tools-systems",
        ...
        "治理工具、系統整合與平台管理",
        ["tools", "systems", "platform", "integration"],
        "operational",
        ["01-architecture"],
    ),
    (
        ...
        "組織文化、能力建設與培訓治理",
        ["culture", "capability", "training", "competency"],
        "operational",
        ["00-vision-strategy"],
    ),
    (
        ...
        "指標定義、數據收集與報告生成",
        ["metrics", "reporting", "dashboard", "analytics"],
        "operational",
        ["09-performance"],
    ),
    (
        ...
        "持續改善、PDCA循環與優化治理",
        ["improvement", "pdca", "optimization", "continuous"],
        "operational",
        ["08-process", "09-performance"],
    ),
    (
        "15",
        "economic",
        ...
        "Economic Governance",
        "成本管理、預算控制與經濟效益治理",
        ["economic", "cost", "budget", "roi"],
        "operational",
        ["00-vision-strategy", "04-risk"],
    ),
    (
        "16",
        "psychological",
        ...
        "認知負荷、心理安全與使用者體驗治理",
        ["psychological", "cognitive", "safety", "ux"],
        "operational",
    ...
    (
        ...
        "sociological",
        "社會學治理",
        "Sociological Governance",
        "社會互動、協作模式與組織行為治理",
        ["sociological", "collaboration", "interaction", "behavior"],
        "operational",
        ["12-culture-capability"],
    ),
    (
        ...
        "複雜適應系統、湧現行為與系統動力學治理",
        ["complex", "system", "emergence", "dynamics"],
        "operational",
        ["01-architecture", "04-risk"],
    ),
    (
        "19",
        "evolutionary",
        ...
        "演化架構、適應性變化與治理演進",
        ["evolutionary", "adaptive", "evolution", "fitness"],
        "operational",
        ["14-improvement", "18-complex-system"],
    ),
    (
        "20",
        "intent",
        "意圖治理",
        "Intent Governance",
        "Intent-based Orchestration、語意映射與自動執行",
        ["intent", "orchestration", "semantic", "automation"],
        "operational",
        ["10-policy", "01-architecture"],
    ),
    (
        "21",
        "ecological",
        ...
        "環境考量、永續發展與綠色IT治理",
        ["ecological", "sustainability", "green", "environment"],
        "operational",
        ["00-vision-strategy"],
    ),
    (
        ...
        "設計美學、使用者介面與體驗治理",
        ["aesthetic", "design", "ui", "experience"],
        "operational",
        ["16-psychological"],
    ),
    (
        ...
        "Policy Definitions",
        "具體政策規則、例外處理與政策模板",
        ["policies", "rules", "templates", "exceptions"],
        "operational",
        ["10-policy"],
    ),
    (
        ...
        "Registry Governance",
        "元件登錄、服務目錄與依賴管理",
        ["registry", "catalog", "dependencies", "discovery"],
        "operational",
        ["01-architecture"],
    ),
    (
        ...
        "治理原則、指導方針與價值觀定義",
        ["principles", "guidelines", "values", "standards"],
        "operational",
        ["00-vision-strategy"],
    ),
    (
        ...
        "Tools Governance",
        "治理工具集、自動化腳本與輔助程式",
        ["tools", "scripts", "utilities", "automation"],
        "operational",
        ["11-tools-systems"],
    ),
    (
        ...
        "配置模板、標準範本與快速啟動",
        ["templates", "boilerplate", "quickstart", "standards"],
        "operational",
        ["01-architecture"],
    ),
    (
        ...
        "Tests Governance",
        "測試框架、驗證策略與品質保證",
        ["tests", "validation", "qa", "verification"],
        "operational",
        ["07-audit"],
    ),
    (
        ...
        "文檔標準、知識管理與內容治理",
        ["docs", "documentation", "knowledge", "content"],
        "operational",
        ["00-vision-strategy"],
    ),
    ...
    (
        ...
        "代理治理",
        "Agents Governance",
        "AI Agent生命週期、權限管理與合規追蹤",
        ["agents", "ai", "lifecycle", "permissions"],
        "execution",
        ["10-policy", "20-intent"],
    ),
    (
        ...
        "結構治理",
        "Schemas Governance",
        "JSON Schema、資料結構與驗證規則",
        ["schemas", "validation", "structure", "types"],
        "execution",
        ["01-architecture"],
    ),
    (
        ...
        "Rules Governance",
        "業務規則、決策邏輯與規則引擎",
        ["rules", "logic", "engine", "decision"],
        "execution",
        ["10-policy", "23-policies"],
    ),
    (
        "33",
        "common",
    ...
    (
        ...
        "Config Governance",
        "配置管理、環境變數與參數化設定",
        ["config", "environment", "parameters", "settings"],
        "execution",
        ["27-templates"],
    ),
    (
        ...
        "Scripts Governance",
        "自動化腳本、批次作業與任務執行",
        ["scripts", "automation", "batch", "tasks"],
        "execution",
        ["26-tools"],
    ),
    (
        ...
        "Modules Governance",
        "模組定義、介面規範與依賴管理",
        ["modules", "interface", "dependencies", "packaging"],
        "execution",
        ["01-architecture", "24-registry"],
    ),
    (
        "37",
        "behavior-contracts",
        "行為契約治理",
        "Behavior Contracts Governance",
        "行為契約、不變量定義與副作用聲明",
        ["contracts", "behavior", "invariants", "effects"],
        "execution",
        ["30-agents", "36-modules"],
    ),
    (
        "38",
        "sbom",
        ...
        "SBOM Governance",
        "軟體供應鏈、來源追蹤與簽章驗證",
        ["sbom", "supply-chain", "provenance", "signing"],
        "execution",
        ["06-security", "05-compliance"],
    ),
    (
        "39",
        "automation",
        ...
        "自動化引擎、任務調度與工作流程",
        ["automation", "engine", "scheduling", "workflow"],
        "execution",
        ["08-process", "35-scripts"],
    ),
    (
        "40",
        "self-healing",
        ...
        "自動復原、故障偵測與預防性維護",
        ["self-healing", "recovery", "detection", "prevention"],
        "execution",
        ["39-automation", "04-risk"],
    ),
    (
        "41",
        "orchestration",
        ...
        "服務編排、容器調度與資源管理",
        ["orchestration", "kubernetes", "containers", "resources"],
        "execution",
        ["20-intent", "39-automation"],
    ),
    (
        "42",
        "deployment",
        ...
        "部署策略、發布管理與環境管理",
        ["deployment", "release", "environment", "strategy"],
        "execution",
        ["41-orchestration", "03-change"],
    ),
    (
        "43",
        "scaling",
        ...
        "Scaling Governance",
        "自動擴展、容量規劃與資源優化",
        ["scaling", "autoscaling", "capacity", "optimization"],
        "execution",
        ["41-orchestration", "09-performance"],
    ),
    (
        "44",
        "resilience",
    ...
    (
        ...
        "Recovery Governance",
        "備份策略、復原程序與RTO/RPO管理",
        ["recovery", "backup", "rto", "rpo"],
        "execution",
        ["44-resilience", "40-self-healing"],
    ),
    (
        "46",
        "migration",
        ...
        "資料遷移、系統遷移與現代化治理",
        ["migration", "modernization", "data", "system"],
        "execution",
        ["03-change", "42-deployment"],
    ),
    (
        "47",
        "versioning",
        ...
        "語意版本控制、相容性管理與棄用策略",
        ["versioning", "semver", "compatibility", "deprecation"],
        "execution",
        ["03-change", "36-modules"],
    ),
    (
        "48",
        "rollback",
        ...
        "Rollback Governance",
        "回滾策略、狀態恢復與安全回退",
        ["rollback", "revert", "recovery", "safety"],
        "execution",
        ["42-deployment", "47-versioning"],
    ),
    (
        "49",
        "canary",
        ...
        "Canary Governance",
        "金絲雀部署、漸進式發布與A/B測試",
        ["canary", "progressive", "ab-testing", "rollout"],
        "execution",
        ["42-deployment", "43-scaling"],
    ),
    ...
    (
        ...
        "Logging Governance",
        "結構化日誌、日誌聚合與保留策略",
        ["logging", "structured", "aggregation", "retention"],
        "observability",
        ["07-audit"],
    ),
    (
        ...
        "Tracing Governance",
        "分散式追蹤、span收集與因果關係",
        ["tracing", "distributed", "spans", "causality"],
        "observability",
        ["50-monitoring"],
    ),
    (
        ...
        "Alerting Governance",
        "告警規則、通知管道與告警疲勞管理",
        ["alerting", "notifications", "rules", "fatigue"],
        "observability",
        ["50-monitoring", "04-risk"],
    ),
    (
        "54",
        "dashboards",
        ...
        "儀表板設計、視覺化標準與即時展示",
        ["dashboards", "visualization", "grafana", "display"],
        "observability",
        ["50-monitoring", "13-metrics-reporting"],
    ),
    (
        "55",
        "slo-sli",
    ...
    (
        ...
        "事件管理、分類分級與響應流程",
        ["incidents", "response", "classification", "management"],
        "observability",
        ["53-alerting", "04-risk"],
    ),
    (
        ...
        "postmortems",
        "事後分析治理",
        "Postmortems Governance",
        "事後分析、根因分析與改善行動",
        ["postmortems", "rca", "blameless", "improvement"],
        "observability",
        ["56-incidents", "14-improvement"],
    ),
    (
        "58",
        "capacity",
        ...
        "Capacity Governance",
        "容量規劃、資源預測與成本優化",
        ["capacity", "planning", "prediction", "optimization"],
        "observability",
        ["43-scaling", "50-monitoring"],
    ),
    (
        "59",
        "forecasting",
        ...
        "趨勢預測、異常預警與容量預估",
        ["forecasting", "trends", "anomaly", "prediction"],
        "observability",
        ["58-capacity", "13-metrics-reporting"],
    ),
    (
        "60",
        "contracts",
        ...
        "契約登錄、介面驗證與相容性檢查",
        ["contracts", "interface", "compatibility", "registry"],
        "observability",
        ["37-behavior-contracts", "36-modules"],
    ),
    (
        "61",
        "lineage",
        ...
        "Lineage Governance",
        "資料血緣、依賴追蹤與影響分析",
        ["lineage", "data", "dependencies", "impact"],
        "observability",
        ["07-audit", "52-tracing"],
    ),
    (
        ...
        "來源追蹤、版本歷史與變更記錄",
        ["provenance", "origin", "history", "tracking"],
        "observability",
        ["38-sbom", "61-lineage"],
    ),
    (
        ...
        "Evidence Governance",
        "證據收集、證據鏈與不可變儲存",
        ["evidence", "chain", "immutable", "collection"],
        "observability",
        ["07-audit", "62-provenance"],
    ),
    (
        "64",
        "attestation",
        ...
        "數位簽章、認證聲明與信任驗證",
        ["attestation", "signature", "trust", "verification"],
        "observability",
        ["63-evidence", "06-security"],
    ),
    (
        "65",
        "certification",
        ...
        "合規驗證、標準認證與持續合規",
        ["certification", "compliance", "standards", "continuous"],
        "observability",
        ["05-compliance", "64-attestation"],
    ),
    (
        "66",
        "reporting",
        ...
        "自動報告生成、排程與分發",
        ["reporting", "generation", "scheduling", "distribution"],
        "observability",
        ["13-metrics-reporting", "07-audit"],
    ),
    (
        "67",
        "analytics",
        ...
        "資料分析、洞察發現與決策支援",
        ["analytics", "insights", "decision-support", "data"],
        "observability",
        ["50-monitoring", "59-forecasting"],
    ),
    (
        "68",
        "visualization",
        ...
        "資料視覺化、圖表標準與互動展示",
        ["visualization", "charts", "interactive", "display"],
        "observability",
        ["54-dashboards", "67-analytics"],
    ),
    (
        "69",
        "correlation",
        ...
        "事件關聯、因果分析與模式識別",
        ["correlation", "causality", "patterns", "analysis"],
        "observability",
        ["52-tracing", "67-analytics"],
    ),
    ...
    (
        ...
        "完整稽核軌跡、時間戳與不可變記錄",
        ["audit-trail", "timestamp", "immutable", "records"],
        "feedback",
        ["07-audit", "63-evidence"],
    ),
    (
        "71",
        "feedback-loops",
        ...
        "閉環回饋、持續監控與自動調整",
        ["feedback", "loops", "closed-loop", "adjustment"],
        "feedback",
        ["14-improvement", "50-monitoring"],
    ),
    (
        "72",
        "optimization",
        ...
        "效能優化、資源優化與成本優化",
        ["optimization", "performance", "resources", "cost"],
        "feedback",
        ["71-feedback-loops", "67-analytics"],
    ),
    (
        "73",
        "learning",
        ...
        "Learning Governance",
        "機器學習、模型訓練與知識積累",
        ["learning", "ml", "training", "knowledge"],
        "feedback",
        ["72-optimization", "30-agents"],
    ),
    (
        "74",
        "adaptation",
        ...
        "自適應調整、動態配置與環境適應",
        ["adaptation", "dynamic", "environment", "adjustment"],
        "feedback",
        ["73-learning", "19-evolutionary"],
    ),
    (
        "75",
        "evolution",
        ...
        "系統演化、架構演進與治理進化",
        ["evolution", "architecture", "progression", "fitness"],
        "feedback",
        ["74-adaptation", "19-evolutionary"],
    ),
    (
        "76",
        "innovation",
        ...
        "創新管理、實驗文化與新興技術治理",
        ["innovation", "experimentation", "emerging", "technology"],
        "feedback",
        ["75-evolution", "00-vision-strategy"],
    ),
    (
        "77",
        "experimentation",
        ...
        "A/B測試、特徵標誌與實驗框架",
        ["experimentation", "ab-testing", "feature-flags", "framework"],
        "feedback",
        ["76-innovation", "49-canary"],
    ),
    (
        "78",
        "simulation",
        ...
        "數位孿生、場景模擬與what-if分析",
        ["simulation", "digital-twin", "scenarios", "what-if"],
        "feedback",
        ["77-experimentation", "18-complex-system"],
    ),
    (
        "79",
        "prediction",
        ...
        "預測模型、趨勢分析與前瞻性治理",
        ["prediction", "models", "trends", "proactive"],
        "feedback",
        ["59-forecasting", "73-learning"],
    ),
    (
        "80",
        "synthesis",
        ...
        "跨維度綜合、整體優化與治理整合",
        ["synthesis", "integration", "holistic", "optimization"],
        "feedback",
        ["79-prediction", "00-vision-strategy"],
    ),
]
