...
class LanguageGovernanceAnalyzer:
    ...
    def generate_markdown_report(self) -> str:
        ...
        lines.append("\n### 📚 References\n")
        lines.append(
            "- [Language Stack Documentation](../blob/main/docs/architecture/language-stack.md)"
        )
        lines.append(
            "- [Language Governance](../blob/main/docs/architecture/language-governance.md)"
        )
...
def main():
    ...
    parser.add_argument("--output-file", help="Output file path (for json/markdown)")
