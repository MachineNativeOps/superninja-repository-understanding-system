...
class MultiLanguageSupport:
    ...
    async def detect_optimal_language(self, requirements: ProjectRequirements) -> str:
        ...
        try:
            ...
            if requirements.security_level == "enterprise":
                candidates = [
                    lang for lang in candidates if self.supported_languages[lang].enterprise_ready
                ]

            # 基於規模篩選
            if requirements.scale == "enterprise":
                candidates = [
                    lang for lang in candidates if lang in ["java", "go", "python", "rust"]
                ]
    ...
    def get_supported_languages(
        ...
        if language_type:
            return [
                lang for lang in self.supported_languages.values() if lang.type == language_type
            ]
