...
try:
    from .expert_base import ExpertiseLevel, VirtualExpert
except ImportError:
    from expert_base import ExpertiseLevel, VirtualExpert
...
class VirtualExpertTeam:
    ...
    def get_expert(self, expert_id: str) -> Optional[VirtualExpert]:
        """Get an expert by ID."""
    ...
    def _detect_domains(self, query: str, code: Optional[str]) -> List[str]:
    ...
    def get_consultation(self, consultation_id: str) -> Optional[ExpertConsultation]:
        """Get a consultation by ID."""
        return self.consultations.get(consultation_id)

    def get_result(self, consultation_id: str) -> Optional[ConsultationResult]:
