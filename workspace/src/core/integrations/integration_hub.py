...
class IntegrationHub:
    ...
    async def send_response(
        self, request_id: str, source_phase: int, payload: Dict[str, Any]
    ) -> None:
        """
    ...
    def subscribe(self, phase_id: int, event_pattern: str, handler: Callable) -> str:
        """
        Subscribe to events
        ...
        subscription = Subscription(
            id=sub_id, phase_id=phase_id, event_pattern=event_pattern, handler=handler
        )
