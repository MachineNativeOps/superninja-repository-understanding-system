...
class WorkConfigurationManager:
    ...
    def list_configurations(
        self, status: Optional[WorkConfigurationStatus] = None
    ...
    def add_capability_to_config(self, config_id: str, capability_id: str) -> bool:
        """
    ...
    def add_policy_to_config(self, config_id: str, policy_id: str) -> bool:
        """
    ...
    def validate_configuration(self, config_id: str) -> Dict[str, Any]:
        """
    ...
    def _validate_reference(self, ref: ConfigurationReference) -> Dict[str, Any]:
    ...
    def _validate_capability(self, capability: CapabilityMapping) -> Dict[str, Any]:
