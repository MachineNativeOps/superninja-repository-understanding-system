...
class SelfHealingSystem:
    ...
    async def heal_workflow(
        self, workflow_result: Dict[str, Any], user_input: str, context: Dict[str, Any]
    ) -> Dict[str, Any]:
        """修復失敗的工作流"""
        ...
        try:
            ...
            return {"success": False, "healing_id": healing_id, "error": str(e)}
    ...
    async def _execute_healing_strategy(
        self, strategy: Dict[str, Any], workflow_result: Dict[str, Any]
    ) -> Dict[str, Any]:
        """執行修復策略"""
    ...
    async def _execute_retry_strategy(
        self, workflow_result: Dict[str, Any], parameters: Dict[str, Any]
    ) -> Dict[str, Any]:
        """執行重試策略"""
        # 這裡會重新執行失敗的任務
    ...
    async def _execute_scaling_strategy(
        self, workflow_result: Dict[str, Any], parameters: Dict[str, Any]
    ) -> Dict[str, Any]:
        """執行擴展策略"""
        return {
    ...
    async def health_check(self) -> Dict[str, Any]:
        ...
        success_rate = (
            len([h for h in recent_healings if h["success"]]) / len(recent_healings)
            if recent_healings
            else 1.0
        )
    ...
    async def optimize_system(self, workflow_result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            self._record_optimization(
                optimization_id, bottlenecks, recommendations, applied_optimizations
            )
