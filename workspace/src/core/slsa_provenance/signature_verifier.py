...
class SignatureResult:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "transparencyEntry": (
                self.transparency_entry.to_dict() if self.transparency_entry else None
            ),
...
class SignatureVerifier:
    ...
    def verify_signature(
        ...
        result = SignatureResult(
            status=VerificationStatus.UNKNOWN, signature_type=SignatureType.SIGSTORE
        )
        ...
        try:
            ...
            verify_result = self._cryptographic_verify(
                artifact_digest, sig_data, result.certificate
            )
    ...
    def verify_bundle(
        self, bundle: Dict[str, Any], policy: Optional[VerificationPolicy] = None
    ) -> SignatureResult:
        """
    ...
    def create_policy(self, name: str, **kwargs) -> VerificationPolicy:
    ...
    def _check_transparency_log(
        self, artifact_digest: str, signature: str
    ...
    def _cryptographic_verify(
        self, artifact_digest: str, signature: bytes, certificate: Optional[Certificate]
    ) -> Dict[str, Any]:
        """
