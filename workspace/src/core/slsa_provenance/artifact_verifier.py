...
class ArtifactMetadata:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        result = {"name": self.name, "digest": self.digest}
...
class VerificationResult:
    ...
    def is_verified(self) -> bool:
        ...
        return (
            ...
            and self.provenance_status == ProvenanceStatus.VERIFIED
        )
...
class ArtifactVerifier:
    ...
    def __init__(self, default_policy: Optional[VerificationPolicy] = None):
        """
    ...
    def get_cached_result(
        self, artifact_name: str, digest: Dict[str, str]
    ...
    def _get_content_metadata(self, content: bytes, name: str) -> ArtifactMetadata:
        """Get metadata for content bytes"""
        digest = {"sha256": hashlib.sha256(content).hexdigest()}

        return ArtifactMetadata(name=name, digest=digest, size=len(content))
    ...
    def _verify_integrity(
        ...
        result = {"status": IntegrityStatus.VERIFIED, "checks": [], "errors": []}
        ...
        result["checks"].append({"name": "digest_presence", "passed": True})
    ...
    def _verify_provenance(
        ...
        result["checks"].append({"name": "subject_match", "passed": True})
    ...
    def _check_policy_compliance(
        self, result: VerificationResult, policy: VerificationPolicy
    ) -> Dict[str, Any]:
        """Check if result meets policy requirements"""
        compliance = {"policy_name": policy.name, "compliant": True, "checks": []}
        ...
        if result.slsa_level < policy.min_slsa_level:
            ...
            compliance["checks"].append({"name": "min_slsa_level", "passed": True})
