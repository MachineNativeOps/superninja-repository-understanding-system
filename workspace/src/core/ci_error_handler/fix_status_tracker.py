...
class FixStatusTracker:
    ...
    def start_tracking(
        self, error_id: str, error_category: str, issue_number: Optional[int] = None
    ) -> TrackedFix:
        """
    ...
    def add_attempt(self, error_id: str, attempt: FixAttempt) -> Optional[TrackedFix]:
        """
    ...
    def mark_pr_merged(
        self, error_id: str, commit_sha: str, merged_by: Optional[str] = None
    ) -> Optional[TrackedFix]:
        """
    ...
    def mark_failed(self, error_id: str, failure_reason: str) -> Optional[TrackedFix]:
        """
