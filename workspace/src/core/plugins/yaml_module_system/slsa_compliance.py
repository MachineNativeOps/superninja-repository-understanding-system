...
class SLSAProvenance:
    ...
    build_definition: BuildDefinition | None = None
...
class SLSAProvenanceGenerator:
    ...
    def __init__(self, builder_id: str, builder_version: str | None = None):
    ...
    def generate_from_module(
        self, module_data: dict[str, Any], build_params: dict[str, Any]
    ) -> SLSAProvenance:
        """從模組生成溯源"""
        # 計算模組摘要
...
class ArtifactSigner:
    ...
    def sign(self, artifact_name: str, artifact_data: Any) -> SignedArtifact:
        ...
        # 計算摘要
        data_str = (
            json.dumps(artifact_data, sort_keys=True)
...
class SBOMGenerator:
    ...
    def generate(
        self, name: str, version: str, dependencies: list[dict[str, Any]] | None = None
    ) -> SBOM:
        """
        生成 SBOM
