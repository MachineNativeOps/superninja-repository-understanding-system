...
class WorkflowStep:
    ...
    on_success: str | None = None  # Step ID to run on success
    on_failure: str | None = None  # Step ID to run on failure
...
class WorkflowOrchestrator:
    ...
    async def execute_workflow_async(
        ...
        task = asyncio.create_task(self.execute_workflow(workflow_id, input_data))
    ...
    def get_workflow_status(self, execution_id: str) -> WorkflowResult | None:
    ...
    async def _execute_steps(self, workflow: Workflow, context: dict[str, Any]) -> list[StepResult]:
        ...
        while pending_steps:
            ...
            # Process results
            for step, result in zip(parallel_batch, batch_results, strict=False):
    ...
    def _get_step(self, workflow: Workflow, step_id: str) -> WorkflowStep | None:
...
def create_workflow(name: str, steps: list[WorkflowStep], **kwargs) -> Workflow:
    ...
    return Workflow(
        ...
        steps=[
            ...
            WorkflowStep(
                ...
                name="Generate Tests",
                tool="generate-tests",
                arguments={"code": "${input.code}", "framework": "jest"},
            ...
            WorkflowStep(
                ...
                tool="generate-docs",
                arguments={"code": "${input.code}", "format": "markdown"},
