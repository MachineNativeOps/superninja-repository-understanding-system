...
class ExecutionEngine:
    ...
    def _get_required_connectors(
        ...
        # 根據行動類型返回所需的連接器
        connector_map = {
            ActionType.DATABASE: ["database_connector"],
            ActionType.DEPLOYMENT: ["kubernetes_connector", "docker_connector"],
            ActionType.FILE_SYSTEM: ["filesystem_connector"],
            ActionType.NETWORK: ["network_connector"],
            ActionType.API_CALL: ["http_connector"],
            ActionType.CONFIGURATION: ["config_connector"],
            ActionType.SECURITY: ["security_connector"],
            ActionType.MONITORING: ["metrics_connector"],
        }
