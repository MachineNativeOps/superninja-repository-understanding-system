...
class LangChainToolAdapter:
    ...
    def get_adapted(self, tool_name: str) -> Optional[LangChainToolFormat]:
...
class ReActAgentBuilder:
    ...
    def __init__(self, tool_adapter: Optional[LangChainToolAdapter] = None):
        self.tool_adapter = tool_adapter or LangChainToolAdapter()
        self._agents: Dict[str, Dict[str, Any]] = {}

    def build_agent(self, config: AgentConfig, tools: List[Any]) -> Dict[str, Any]:
        """
    ...
    async def run_agent(
        self, agent_name: str, input_text: str, context: Optional[Dict[str, Any]] = None
        ...
        try:
            ...
            for iteration in range(max_iterations):
                ...
                intermediate_steps.append(
                    {"type": "thought", "content": thought, "iteration": iteration + 1}
                )
