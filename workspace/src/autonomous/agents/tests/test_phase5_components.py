...
class TestHallucinationDetector:
    ...
    def test_custom_validator_registration(self):
        ...
        custom_issues = [h for h in result.hallucinations if "Custom" in h.description]
...
class TestContextUnderstandingEngine:
    ...
    def test_parse_optimization_intent(self):
        ...
        engine = ContextUnderstandingEngine()
        result = engine.analyze_request("user-1", "幫我優化這個查詢的效能")
    ...
    def test_parse_debugging_intent(self):
        ...
        engine = ContextUnderstandingEngine()
        result = engine.analyze_request("user-1", "Please fix this bug in my code")
    ...
    def test_detect_ambiguities(self):
        ...
        engine = ContextUnderstandingEngine()
        result = engine.analyze_request("user-1", "Fix it")  # Very ambiguous request
    ...
    def test_identify_implicit_requirements(self):
        ...
        engine = ContextUnderstandingEngine()
        result = engine.analyze_request("user-1", "我需要遷移大量用戶資料到生產環境")
    ...
    def test_add_project_context(self):
        ...
        context_id = engine.add_project_context(
            "user-1",
            {
                "is_production": True,
    ...
    def test_recommended_approach_generation(self):
        ...
        engine = ContextUnderstandingEngine()
        result = engine.analyze_request("user-1", "我需要將用戶資料遷移到新系統")
...
class TestPhase5Integration:
    ...
    def test_context_aware_bug_detection(self):
        ...
        context_engine.add_project_context(
            "user-1",
            {
                "is_production": True,
                "has_sensitive_data": True,
        ...
        context_result = context_engine.analyze_request(
            "user-1", "Check my user authentication code"
        )
        ...
        # In production context with sensitive data, should definitely flag
        # this
        assert len(security_bugs) > 0
