...
class TestToolRegistry:
    ...
    def test_register_tool(self):
        ...
        tool = Tool(name="test", description="Test", category=ToolCategory.CODE)
...
class TestReActAgentBuilder:
    ...
    def test_build_agent(self):
        ...
        tools = [Tool(name="search", description="Search", category=ToolCategory.API)]
...
class TestTaskPlanner:
    ...
    def test_decompose_task(self):
        ...
        plan = planner.decompose_task(
            "Query the database and deploy the result", ["database", "deployment"]
        )
...
class TestAgentOrchestrator:
    ...
    def test_create_agent(self):
        ...
        agent = orchestrator.create_agent(
            agent_id="agent1", agent_type="worker", capabilities=["database", "api"]
        )
    ...
    async def test_execute_plan(self):
        ...
        plan = planner.create_plan(name="Simple Plan", steps=[{"name": "Step 1"}])
...
class TestToolFactories:
    ...
    def test_create_database_tool(self):
        ...
        tool = create_database_tool(
            name="query", description="Query DB", execute_fn=lambda x: "query result"
        )
    ...
    def test_create_api_tool(self):
        ...
        tool = create_api_tool(
            name="fetch", description="Fetch data", execute_fn=lambda x: "api result"
        )
