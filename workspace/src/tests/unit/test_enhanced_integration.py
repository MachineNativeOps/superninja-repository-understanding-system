...
class TestServiceRegistry:
    ...
    def test_discover_by_name(self, registry):
        ...
        registry.register_service(
            name="discovery-test", version="1.0.0", category=ServiceCategory.INTEGRATION
        )
    ...
    def test_discover_by_category(self, registry):
        ...
        registry.register_service(
            name="security-service", version="1.0.0", category=ServiceCategory.SECURITY
        )
    ...
    def test_deregister_service(self, registry):
        ...
        service_id = registry.register_service(
            name="temp-service", version="1.0.0", category=ServiceCategory.CORE
        )
    ...
    def test_heartbeat(self, registry):
        ...
        service_id = registry.register_service(
            name="heartbeat-service", version="1.0.0", category=ServiceCategory.CORE
        )
    ...
    def test_get_stats(self, registry):
        ...
        registry.register_service(
            name="stats-service", version="1.0.0", category=ServiceCategory.CORE
        )
...
class TestConfigurationOptimizer:
    ...
    def test_analyze_generates_recommendations(self, optimizer, sample_config):
        ...
        # Higher than dev recommendation
        sample_config["max_concurrent_tasks"] = 100
