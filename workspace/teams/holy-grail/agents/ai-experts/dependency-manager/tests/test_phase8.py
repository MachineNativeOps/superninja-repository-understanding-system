...
class TestDynamicAdjuster(unittest.TestCase):
    ...
    def test_evaluate_market(self):
        ...
        result = self.adjuster.evaluate_market(
            satisfaction=55, competitor_moves=["新產品", "降價"], trends=["技術革新"]
        )
...
class TestQuarterlyReviewEngine(unittest.TestCase):
    ...
    def test_add_review_item(self):
        ...
        self.engine.add_review_item(
            "2024Q2", ReviewCategory.FINANCIAL_PERFORMANCE, "ROI", 100.0, 85.0, "%"
        )
    ...
    def test_generate_markdown_report(self):
        ...
        self.engine.add_review_item(
            "2024Q4", ReviewCategory.INTERNAL_CAPABILITY, "技能成長", 15, 12, "%"
        )
...
class TestIntegration(unittest.TestCase):
    ...
    def test_full_workflow(self):
        ...
        review_engine.add_review_item(
            "2025Q1", ReviewCategory.FINANCIAL_PERFORMANCE, "ROI", 100, 90, "%"
        )
