...
class ContractGenerator:
    ...
    def _build_contract_from_template(
        self, template: ContractTemplate, description: str, analysis: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    def _populate_template(
        self, contract: Dict[str, Any], parameters: Dict[str, Any]
    ) -> Dict[str, Any]:
    ...
    def _validate_contract(self, contract: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {"status": status, "warnings": warnings, "suggestions": suggestions}
    ...
    def export_to_yaml(self, contract: GeneratedContract, output_path: Path):
    ...
    def export_to_json(self, contract: GeneratedContract, output_path: Path):
        """Export contract to JSON file"""
        output_path.parent.mkdir(parents=True, exist_ok=True)

        with open(output_path, "w") as f:
            json.dump({"contracts": [contract.contract_definition]}, f, indent=2)
