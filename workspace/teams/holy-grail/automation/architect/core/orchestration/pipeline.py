...
class AnalysisPipeline:
    ...
    async def _run_static_analysis(self, code_path: str) -> Dict:
        ...
        try:
            ...
            return {"status": "completed", "summary": summary, "issues": result.issues}
        except Exception as e:
    ...
    async def _run_architecture_analysis(self, code_path: str) -> Dict:
        ...
        try:
            ...
            return {"status": "completed", "issues_count": len(issues)}
        except Exception as e:
...
async def run_analysis(
    code_path: str, scenario: str = "general", config: Optional[Dict] = None
) -> PipelineResult:
    """
    便利函數：運行代碼分析
