...
class PreDeployTester:
    ...
    def test_business_imports(self):
        """測試業務模組導入"""
        try:
            from src.business import api, models, services, workflows
    ...
    def test_data_models(self):
        ...
        try:
            ...
            # 測試項目模型
            project = Project(id="test-123", name="Test Project", owner="admin")
            ...
            return (
                project.id == "test-123"
                and task.project_id == "test-123"
                and metrics.total_projects == 1
            )
        except Exception as e:
    ...
    def test_scripts_permissions(self):
        """測試腳本權限"""
        try:
            scripts = ["scripts/deploy.sh", "scripts/migrate.py"]
    ...
    def test_directory_structure(self):
        """測試目錄結構"""
        try:
            required_dirs = ["src/business", "src/core/new", "config/prod", "scripts"]
