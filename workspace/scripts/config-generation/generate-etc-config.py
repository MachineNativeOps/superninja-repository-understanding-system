...
class AAPSConfigGenerator:
    ...
    def generate_main_config(self) -> Dict[str, Any]:
        ...
        deployment_config = {
            ...
            "spec": {
                ...
                "project": {
                    "name": config_spec.get("spec", {})
                    .get("project", {})
                    .get("name", "machinenativeops"),
                    "version": config_spec.get("spec", {})
                    .get("project", {})
                    .get("version", "2.0.0"),
                    "environment": config_spec.get("spec", {})
                    .get("environment", {})
                    .get("name", "production"),
                },
                # 引擎配置
                "engine": {
                    ...
                    .get("engine", {})
                    .get("version", "1.0.0"),
                    "capabilities": engine_config.get("spec", {})
                    .get("engine", {})
                    .get("capabilities", []),
                },
                # 運行時配置
                "runtime": {
                    "executionModes": engine_config.get("spec", {})
                    .get("runtime", {})
                    .get("executionModes", []),
                    "resources": engine_config.get("spec", {})
                    .get("runtime", {})
                    .get("resources", {}),
                    "concurrency": engine_config.get("spec", {})
                    .get("runtime", {})
                    .get("concurrency", {}),
                },
                # 安全配置
                "security": {
                    "authentication": engine_config.get("spec", {})
                    .get("security", {})
                    .get("authentication", {}),
    ...
    def generate_modules_config(self) -> Dict[str, Any]:
        ...
        # 載入權威配置
        modules_registry = self.load_yaml(
            self.root_config_dir / "registry" / "root.registry.modules.yaml"
        )
    ...
    def _generate_metadata(self, configs: Dict[str, Any], output_dir: Path):
        ...
        metadata = {
            ...
            "spec": {
                ...
                "validation": {"allConfigsGenerated": True, "configsValid": True},
            },
        }
