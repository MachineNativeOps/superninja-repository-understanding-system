...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("/var/log/naming-governance-repair.log"),
...
class NamingGovernanceRepair:
    ...
    def __init__(self, config_path: str = None):
        """初始化修復系統"""
        self.config_path = config_path or "/etc/naming-governance/config.yaml"
        ...
        for violation in operation.violation_reports:
            try:
                ...
                for label in missing_labels:
                    if label == "managed-by":
                        labels_to_add[label] = "naming-governance"
    ...
    def save_report(self, report: Dict[str, Any], output_path: str = None):
        ...
        if not output_path:
            ...
            output_path = f"/var/log/naming-governance/repair_report_{timestamp}.json"
