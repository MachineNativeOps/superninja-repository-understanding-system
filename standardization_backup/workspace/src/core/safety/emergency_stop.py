...
class EmergencyStop:
    ...
    def register_component(
        ...
        self._components[name] = ComponentStopHandler(
            name=name, stop=stop_handler, recover=recovery_handler, subsystem=subsystem
        )
    ...
    def _get_components_for_scope(
        self, scope: StopScope, specific_components: Optional[List[str]] = None
    ) -> List[str]:
    ...
    async def recover(self, components: Optional[List[str]] = None) -> Dict[str, bool]:
        """
