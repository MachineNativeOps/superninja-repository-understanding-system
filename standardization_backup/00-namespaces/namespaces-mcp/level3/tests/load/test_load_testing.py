...
class TestRAGEngineLoad:
    ...
    async def test_rag_sustained_load_1_hour(self):
        ...
        async with aiohttp.ClientSession() as session:
            ...
            def query_generator():
                ...
                return {"query": random.choice(queries), "context_size": 5}
    ...
    async def test_rag_spike_load(self):
        ...
        async with aiohttp.ClientSession() as session:
            ...
            ), f"Error rate too high during spike: {result.error_rate}"
